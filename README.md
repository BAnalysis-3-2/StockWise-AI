...
<h3>Chatbot Commands</h3>
<p>
The chatbot interface supports both menu-driven and natural language queries. Here are some examples:
</p>

<ul>
  <li><strong>Menu Option:</strong> "View Forecasts" → returns latest SKU-level predictions</li>
  <li><strong>Menu Option:</strong> "Simulate Demand" → runs demand simulation engine</li>
  <li><strong>Natural Query:</strong> "Show forecast for P0001 in February"</li>
  <li><strong>Natural Query:</strong> "Simulate demand for Groceries in Winter"</li>
  <li><strong>Natural Query:</strong> "What was the forecast error for Electronics last month?"</li>
</ul>
